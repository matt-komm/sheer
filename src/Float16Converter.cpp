...
uint32 Float16Converter::mantissatable[2048];
uint32 Float16Converter::exponenttable[64];
uint16 Float16Converter::offsettable[64];
uint16 Float16Converter::basetable[512];
uint8  Float16Converter::shifttable[512];

Float16Converter::Float16Converter()
{
...
void Float16Converter::filltables() 
{
    // ==== mantissatable ===
    // -- zero --
    mantissatable[0] = 0;
